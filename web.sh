...
./manage.py rename_apps --database mi --skip-content-type || true
./manage.py distributed_migrate omis_region 0002_alter_ukregionalsettings_table --fake
./manage.py distributed_migrate omis_region 0002_alter_ukregionalsettings_table --fake --database mi
./manage.py distributed_migrate omis_payment 0009_auto_20210816_1601 --fake
./manage.py distributed_migrate omis_payment 0009_auto_20210816_1601 --fake --database mi
./manage.py distributed_migrate omis_market 0002_alter_market_table --fake
./manage.py distributed_migrate omis_market 0002_alter_market_table --fake --database mi
./manage.py distributed_migrate omis_invoice 0013_alter_invoice_table --fake
./manage.py distributed_migrate omis_invoice 0013_alter_invoice_table --fake --database mi
./manage.py distributed_migrate omis_quote 0009_auto_20210816_1601 --fake
./manage.py distributed_migrate omis_quote 0009_auto_20210816_1601 --fake --database mi
